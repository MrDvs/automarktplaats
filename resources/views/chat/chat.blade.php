...
{{-- <div id="chat">
    <div class="offset-4 col-4">
        ...
        <input type="text" class="form-control" placeholder="type je bericht..." v-model="message" @keyup.enter="send">
    </div>
</div> --}}
            ...
            <div class="mesgs">
              ...
              <div class="type_msg">
                <div class="input_msg_write">
                  <input type="text" class="write_msg" placeholder="Type a message" v-model="message" @keyup.enter="send">
